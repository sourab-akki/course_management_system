...
from app.views import edit_student,students_list,professor_enrollments,professor_dashboard,add_course,enrollments_list,enroll_course,courses_list,professors_list,student_home,student_signup,professor_signup
...
urlpatterns = [
    ...
    path('professor_enrollments/', professor_enrollments, name='professor_enrollments'),
